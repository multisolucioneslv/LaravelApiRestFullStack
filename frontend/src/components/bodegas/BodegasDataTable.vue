...
const columns = [
  ...
  },
  {
    ...
    id: 'direccion',
    header: 'Dirección',
    cell: ({ row }) => h('div', {}, row.getValue('direccion') || '-'),
    enableHiding: true, // Toggleable
  },
  {
    accessorKey: 'empresa',
...
const handleBulkDelete = () => {
  const ids = selectedRows.value.map(bodega => bodega.id)
  emit('bulkDelete', ids)
