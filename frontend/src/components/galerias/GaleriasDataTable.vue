...
const columns = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return imagenUrl
        ...
        : h('div', {
            class: 'w-12 h-12 rounded bg-gradient-to-br from-gray-400 to-gray-500 dark:from-gray-700 dark:to-gray-800 flex items-center justify-center text-white font-semibold'
          }, '?')
    },
    enableHiding: true,
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return h('div', {
        class: 'inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium bg-blue-200 text-blue-800 dark:bg-blue-900/30 dark:text-blue-400'
      }, cantidad)
    },
    enableHiding: true,
  },
