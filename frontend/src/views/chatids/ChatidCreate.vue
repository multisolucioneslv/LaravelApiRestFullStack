      ...
      <div class="flex items-center justify-between">
        <div>
          ...
          <p class="text-gray-600 dark:text-gray-400 mt-2">
            Completa el formulario para crear un nuevo ID de chat de Telegram
          </p>
        </div>
        <Button
          type="button"
...
const { createChatid, loading, goToIndex } = useChatids()
