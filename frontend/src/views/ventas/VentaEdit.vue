          ...
          <form @submit.prevent="handleSubmit" class="space-y-8">
            ...
            <div>
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <!-- Cotización (Solo lectura si está vinculada) -->
                <div class="space-y-2">
                  <Label for="cotizacion_id">Cotización Vinculada</Label>
                  <Input
                    id="cotizacion_id"
                    :value="cotizacionInfo"
                    disabled
                    class="bg-gray-100 dark:bg-gray-800"
                  />
                </div>
...
// Información de cotización (para mostrar)
const cotizacionInfo = computed(() => {
  if (!form.cotizacion_id) return 'Sin cotización vinculada'
  return `Cotización vinculada ID: ${form.cotizacion_id}`
})
...
const cargarVenta = async () => {
  try {
    const venta = await fetchVenta(ventaId)
    ...
    form.empresa_id = venta.empresa_id
    form.cotizacion_id = venta.cotizacion_id
    form.moneda_id = venta.moneda_id
    form.tax_id = venta.tax_id
...
const handleSubmit = async () => {
  ...
  try {
    await updateVenta(ventaId, form)
    goToIndex()
  } catch (error) {
