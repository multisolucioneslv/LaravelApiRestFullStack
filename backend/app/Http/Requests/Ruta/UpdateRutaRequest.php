...
class UpdateRutaRequest extends FormRequest
{
    ...
    {
        return [
            'sistema_id' => 'sometimes|required|integer|exists:sistemas,id',
            'ruta' => 'sometimes|required|string|max:255',
            'metodo' => 'sometimes|required|string|in:GET,POST,PUT,PATCH,DELETE,OPTIONS,HEAD',
            'descripcion' => 'nullable|string|max:500',
            'controlador' => 'sometimes|required|string|max:255',
